...
microservices architecture. This software was implemented primarily in Go, with
the functional tests written primarily in Python. I worked for a variety of
different teams, helping out where help was needed. 
...
- Developed a docker based development environment that allowed both developers
  ...
  development process. This also provided a safety net to developers where they
  could do end to end testing as part of their development workflow. 
...
- Responsible for the continuous delivery pipelines for our group, maintained
  the build servers, the git repositories in Gerrit and the Jenkins jobs. Was a
